...
{
    cr_expect(
        ro_arrays_equal(init_ro_array(0), init_ro_array(0)),
...
Test(ro_equality, arrays_equal_diff_dicts_returns_false)
{
    ...
    ro_array_t b = init_ro_array_with(
        ...
        ROVAL_EXPDOUBLE_T(1.25563, 5), ROVAL_DOUBLE(false), ROVAL_NULL,
        ROVAL_ARR(init_ro_array(0)),
        ROVAL_DICT(init_ro_dict_with(1, ROIT_BOOL(string_nofree_of("a"), true)))
    );
...
{
    cr_expect(
        ro_dicts_equal(init_ro_dict(0), init_ro_dict(0)),
...
Test(ro_equality, dicts_equal_diff_dicts)
{
    ro_dict_t a = init_ro_dict_with(
        ...
        ROIT_DICT(
            ...
            init_ro_dict_with(1, ROIT_BOOL(string_nofree_of("a"), false))
        )
    );
